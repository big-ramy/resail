...
async function getCVDocumentDefinition(addWatermark) {
    ...
    if (hasFilledReferences) {
        ...
        referenceEntries.forEach(entry => {
            ...
            const refEmailVal = entry.querySelector('.reference-email')?.value.trim() || '';
