...
const translations = {
    "ar": {
        "create-cv-in-minutes-title": "أنشئ سيرتك الذاتية الاحترافية في دقائق",
        "resail-design-intro": "مع 'رسائل'، يمكنك تصميم سيرة ذاتية مميزة تفتح لك أبواب الفرص. اختر من مجموعة واسعة من القوالب المصممة بعناية لتناسب كل مجال وظيفي.",
        "ideal-cv-maker-subtitle": "أفضل أداة لإنشاء السيرة الذاتية لمسيرتك المهنية",
        "feature-ease-of-use": "سهولة الاستخدام",
        "feature-ease-of-use-desc": "واجهة بديهية تسمح لك بإنشاء سيرتك الذاتية دون أي عناء أو خبرة سابقة في التصميم.",
        "feature-prof-templates": "نماذج احترافية",
        "feature-prof-templates-desc": "مجموعة متنوعة من نماذج السيرة الذاتية العصرية والجذابة التي صممها خبراء التوظيف لضمان أفضل انطباع.",
        "feature-instant-results": "نتائج فورية",
        "feature-instant-results-desc": "احصل على سيرة ذاتية جاهزة للتقديم في غضون دقائق، وخصصها لتناسب الوظيفة التي تتقدم لها.",
        "goto-builder-title": "موقعك المفضل لعمل CV احترافي",
        "goto-builder-desc": "سواء كنت تبحث عن أداة إنشاء سيرة ذاتية بسيطة، أو موقع لعمل CV احترافي، أو برنامج تصميم سيرة ذاتية، فإن 'رسائل' هو خيارك الأفضل. نقدم لك تجربة متكاملة لتصميم نماذج سيرة ذاتية عصرية، ومساعدتك في كتابة سيرة ذاتية قوية وفعالة.",
        "why-resail-title": "لماذا نظام رسائل لإنشاء السيرة الذاتية؟",
        "feature-easy-data-entry-desc": "نماذج سهلة وبديهية لملء جميع بياناتك بسرعة ويسر.",
        "feature-prof-templates-desc-2": "اختر من بين العديد من التصميمات العصرية والجذابة لتناسب ذوقك ومجالك.",
        "feature-lang-support-desc": "أنشئ سيرتك الذاتية بلغتك المفضلة مع ضمان التنسيق الصحيح لكلا الاتجاهين.",
        "feature-instant-preview-desc": "شاهد شكل سيرتك الذاتية فور إدخال البيانات أو اختيار القالب لتضمن المظهر المثالي.",
        "feature-pdf-export-desc": "احصل على سيرتك الذاتية النهائية كملف PDF احترافي جاهز للطباعة أو المشاركة عبر الإنترنت.",
        "feature-payment-desc": "وسائل دفع متعددة تشمل PayPal وخيارات محلية لتسهيل عملية الحصول على سيرتك الذاتية.",
        "testimonial-1-text": "«كانت عملية إنشاء سيرتي الذاتية سهلة وسريعة بشكل لا يصدق. القوالب عصرية واحترافية حقًا. أوصي به بشدة!»",
        "testimonial-2-text": "«أعجبتني حقًا تنوع القوالب وميزة المعاينة الفورية. ساعدني ذلك في اختيار التصميم المثالي لتقديمي.»",
        "about-us-p1": "رسائل هو نظامك المتكامل لإنشاء سير ذاتية احترافية ومؤثرة بسهولة. نقدم مجموعة واسعة من القوالب العصرية والأدوات البديهية لمساعدتك على التميز في سوق العمل بسيرة ذاتية عالية الجودة بصيغة PDF.",
        "about-us-p2": "تركز خدمتنا على تبسيط عملية إنشاء السيرة الذاتية، وتقديم قوالب متنوعة، وضمان الدعم الكامل للغتين العربية والإنجليزية بتنسيق دقيق. احصل على سيرتك الذاتية بصيغة PDF جاهزة للمشاركة بعد عملية دفع سلسة.",
        "our-visitors-title": "زوّارنا",
        "our-visitors-count": "+٢٥٠٠٠",
        "join-thousands-p": "انضم إلى آلاف المستخدمين الذين أنشأوا سيرهم الذاتية الاحترافية بنجاح.",
        "faq-q1": "كيف يمكنني إنشاء سيرة ذاتية؟",
        "faq-a1": "ما عليك سوى النقر على زر 'ابدأ في إنشاء سيرتك الذاتية الآن'، قم بملء بياناتك في النموذج، اختر القالب المناسب، وقم بمعاينة سيرتك الذاتية.",
        "faq-q2": "هل القوالب مجانية؟",
        "faq-a2": "نقدم مجموعة متنوعة من القوالب المجانية والمدفوعة. تتطلب القوالب المدفوعة رسماً بسيطاً للتنزيل أو الطباعة.",
        "faq-q3": "كيف يمكنني تنزيل سيرتي الذاتية؟",
        "faq-a3": "بعد معاينة السيرة الذاتية واختيار القالب، انقر على زر 'طلب تنزيل / طباعة'. سيتم توجيهك لعملية الدفع إذا اخترت قالباً مدفوعاً، وبعدها يمكنك تنزيل الملف بصيغة PDF.",
        "profile-pic-note": "اختر صورة لتحسين مظهر السيرة الذاتية في بعض النماذج.",
        "available-discounts-title": "الخصومات المتاحة",
        "website-input-label": "مدينتك",
        "website-input-placeholder": "أدخل اسم مدينتك",
        "standard-x-templates-title": "نماذج أساسية اكسترا",
        "add_custom_section_btn": "إضافة قسم مخصص",
        "editor_width": "العرض",
        "editor_height": "الارتفاع",
        "discount-new-customer": "للمشترين الجدد",
        "discount-limited-offer": "عرض لفترة محدودة",
        "remove-discount": "إزالة الخصم",
        "card-payment-desc": "(Visa, MasterCard, إلخ عبر Lemon Squeezy)",
        ...
        "color_presets_title": "اختر قالب ألوان",
        ...
        "Creative Templates": "قوالب إبداعية",
        "Creative Template 1 Preview": "معاينة القالب الإبداعي 1",
        "Creative Template 2 Preview": "معاينة القالب الإبداعي 2",
        "Creative Template 3 Preview": "معاينة القالب الإبداعي 3",
        ...
        "choose-payment": "اختر باقتك وطريقة الدفع",
    ...
    "en": {
        "create-cv-in-minutes-title": "Create Your Professional CV in Minutes",
        "resail-design-intro": "With Resail, you can design a standout CV that opens doors to opportunities. Choose from a wide range of templates carefully designed for every career field.",
        "ideal-cv-maker-subtitle": "The Ideal CV Maker for Your Career",
        "feature-ease-of-use": "Ease of Use",
        "feature-ease-of-use-desc": "An intuitive interface that allows you to create your CV effortlessly, with no prior design experience needed.",
        "feature-prof-templates": "Professional Templates",
        "feature-prof-templates-desc": "A diverse collection of modern and attractive templates designed by recruitment experts to ensure the best impression.",
        "feature-instant-results": "Instant Results",
        "feature-instant-results-desc": "Get your CV ready for submission in minutes, and customize it to fit the job you're applying for.",
        "goto-builder-title": "Your Go-To CV and Resume Builder",
        "goto-builder-desc": "Whether you're looking for a simple CV maker, a professional resume builder, or CV design software, Resail is your best choice. We provide a comprehensive experience for designing modern CV templates and helping you write a powerful and effective resume.",
        "why-resail-title": "Why Resail CV Builder?",
        "feature-easy-data-entry-desc": "Intuitive forms to quickly fill in all your information.",
        "feature-prof-templates-desc-2": "Choose from many modern and attractive designs to suit your style.",
        "feature-lang-support-desc": "Create your CV in either Arabic or English with proper formatting.",
        "feature-instant-preview-desc": "See your CV instantly as you build it, ensuring it looks perfect.",
        "feature-pdf-export-desc": "Download your completed CV as a high-quality PDF file, ready to share.",
        "feature-payment-desc": "Pay easily using various methods including PayPal and local options.",
        "testimonial-1-text": "“Creating my CV was incredibly easy and fast. The templates are modern and professional. Highly recommended!”",
        "testimonial-2-text": "“I loved the variety of templates and the instant preview feature. It helped me choose the perfect design for my application.”",
        "about-us-p1": "Resail is your go-to platform for effortlessly creating professional and impactful CVs. We provide a wide range of modern templates and intuitive tools to help you stand out in the job market with a high-quality PDF resume.",
        "about-us-p2": "Our service focuses on simplifying the CV creation process, offering diverse templates, and ensuring full support for both Arabic and English languages with accurate formatting. Download your ready-to-share PDF CV after a seamless payment process.",
        "our-visitors-title": "Our Visitors",
        "our-visitors-count": "+25,000",
        "join-thousands-p": "Join thousands who have successfully created their professional CVs.",
        "faq-q1": "How do I create a CV?",
        "faq-a1": "Simply click on 'Create Your CV Now', fill in your details in the form, choose a template, and preview your CV.",
        "faq-q2": "Are the templates free?",
        "faq-a2": "We offer a variety of free and premium templates. Premium templates require a small fee for download.",
        "faq-q3": "How do I download my CV?",
        "faq-a3": "After previewing your CV, click on 'Request Download / Print'. You will be guided through the payment process if you selected a premium template, and then you can download the PDF.",
        "profile-pic-note": "Choose a picture to enhance the look of your CV in some templates.",
        "available-discounts-title": "Available Discounts",
        "website-input-label": "Your City",
        "website-input-placeholder": "Enter your City",
        "standard-x-templates-title": "StandardX Templates",
        "add_custom_section_btn": "Add Custom Section",
        "editor_width": "Width",
        "editor_height": "Height",
        "discount-new-customer": "For new customers",
        "discount-limited-offer": "Limited time offer",
        "remove-discount": "Remove Discount",
        "card-payment-desc": "(Visa, MasterCard, etc. via Lemon Squeezy)",
        "local-payment-title": "Local Payment",
        "local-payment-desc": "(via STC Pay or Al Rajhi Transfer)",
        "sar-currency": "SAR",
        ...
        "color_presets_title": "Choose a color palette",
        ...
        "custome-section": "Add Custom Section",
        ...
        "Creative Template 1 Preview": "Creative Template 1 Preview",
        "Creative Template 2 Preview": "Creative Template 2 Preview",
        "Creative Template 3 Preview": "Creative Template 3 Preview",
        ...
        "choose-payment": "Choose Your Plan and Payment Method",
        "messages": "Price Paid",
        "payment": "Payment",
        ...
        "back-to-home": "Back to Home",
        "refund-policy-title": "Refund and Dispute Policy",
        "refund-policy-intro-p": "At \"Resail\", we strive to provide a high-quality service and ensure customer satisfaction. Due to the nature of our digital products (CVs generated and downloaded as PDFs), our refund and dispute policy is as follows:",
        "refund-policy-h4-1": "1. Digital Products (PDF CVs)",
        "refund-policy-p-1-1": "Once the payment is completed and the CV is successfully generated and sent to your email (or a download link is provided), the service is considered fully delivered. Therefore, refunds are generally not available for payments made.",
        ...
        "refund-policy-list-1": [
            "<strong>Major Technical Issue:</strong> If a technical problem in our system completely prevented you from generating or downloading the CV, and our support team was unable to resolve the issue within a reasonable time.",
            "<strong>Critical Product Flaw:</strong> If the generated CV contains severe errors resulting from a glitch in our system (not from data entry errors on your part), and we were unable to correct them.",
            "<strong>Duplicate Payment:</strong> If you were accidentally charged more than once for the same service."
        ],
        "refund-policy-h4-3": "3. Refund Request Process",
        "refund-policy-p-3-1": "To request a refund, please contact our support team via email at <a href=\"mailto:ramyheshamamer@gmail.com\">ramyheshamamer@gmail.com</a> within 7 days of the purchase date. Your request must include:",
        "refund-policy-list-2": [
            "Your full name and the email address used for the purchase.",
            "The date and transaction number (if available).",
            "A detailed description of the problem you encountered and the reasons for your refund request.",
            "Any screenshots or documents that support your claim."
        ],
        "refund-policy-h4-4": "4. Request Review",
        "refund-policy-p-4-1": "All refund requests will be reviewed carefully. You will be notified of the decision within 5 business days of receiving your request. If the refund is approved, the amount will be processed to the original payment method within 7-14 business days, depending on your payment processor's policies.",
        "refund-policy-h4-5": "5. Dispute Resolution",
        "refund-policy-p-5-1": "We encourage you to contact us directly with any issues or disputes before resorting to your payment processor or bank. We aim to resolve all problems amicably and fairly to ensure our customers' satisfaction.",
        "privacy-policy-title": "Privacy Policy",
        "privacy-policy-intro-p": "At \"Resail\", we are committed to protecting the privacy of your personal data. This policy explains how we collect, use, protect, and manage the information you provide when using our services to create CVs.",
        "privacy-policy-h4-1": "1. Information We Collect",
        "privacy-policy-list-1": [
            "<strong>CV Information:</strong> We collect the information you enter directly into the CV creation forms, such as your full name, job title, email address, phone number, personal website/portfolio, career objective, work experience details, educational qualifications, skills, languages, and references. If you upload a profile picture, we collect that as well.",
            "<strong>Contact and Payment Information:</strong> When you make a purchase, we collect your name, email, and phone number. Payment details (such as credit card numbers) are processed directly by secure third-party payment gateways (like Lemon Squeezy/Stripe), and we do not store this sensitive information on our servers.",
            "<strong>Usage Data:</strong> We may collect information about how you access and use our service, such as your IP address, browser type, pages visited, and time spent on each page. This data is used to improve the service and is not directly linked to your personal information."
        ],
        ...
        "privacy-policy-list-2": [
            "To provide and personalize the CV creation service for you.",
            "To process your payment transactions and provide you with the final product (the PDF CV file).",
            "To improve and develop our services and features.",
            "To communicate with you regarding your use of the service, for technical support, or to send important updates.",
        ...
        "privacy-policy-list-3": [
            "<strong>Third-Party Service Providers:</strong> Such as payment gateways (Lemon Squeezy/Stripe) and email processors, only to the extent necessary to provide our services. These providers are obligated to maintain the confidentiality of your information.",
            "<strong>Legal Compliance:</strong> We may disclose your information if required by law or a court order, or to protect our rights and interests or the rights of other users."
        ],
        "privacy-policy-h4-4": "4. Data Security",
        "privacy-policy-p-4-1": "We take reasonable and appropriate security measures to protect your personal information from unauthorized access, alteration, disclosure, or destruction. However, you should be aware that no method of transmission over the Internet or electronic storage is 100% secure.",
        "privacy-policy-h4-5": "5. Your Rights",
        "privacy-policy-p-5-1": "You have the right to access the personal data we hold about you, request the correction of any inaccurate information, or request the deletion of your data. To exercise these rights, please contact us via the email address listed below.",
        "privacy-policy-h4-6": "6. Changes to the Privacy Policy",
        "privacy-policy-p-6-1": "We reserve the right to modify or update this privacy policy from time to time. Any changes will be posted on this page, and your continued use of the service after the changes are published constitutes your acceptance of the revised policy.",
        "privacy-policy-h4-7": "7. Contact Us",
        "privacy-policy-p-7-1": "For any questions or inquiries regarding this privacy policy, please contact us via email: <strong><a href=\"mailto:ramyheshamamer@gmail.com\">ramyheshamamer@gmail.com</a></strong>."
    }
};
