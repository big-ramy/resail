...
const translations = {
  ar: {
    summary_email_required:
      "الرجاء إدخال بريدك الإلكتروني في حقل النبذة للمتابعة.",
    "image-paths": {
    ...
    "File size exceeds the limit (3MB).":
      "حجم الملف يتجاوز الحد المسموح به (3 ميجابايت).",
    "Please attach only image or PDF files.":
      "الرجاء إرفاق ملفات صور أو PDF فقط.",
    "An error occurred while preparing your payment. Please try again or contact support.":
      "حدث خطأ أثناء تحضير عملية الدفع. يرجى المحاولة مرة أخرى أو الاتصال بالدعم.",
    "Error, price for this category is undefined.":
      "حدث خطأ، السعر لهذه الفئة غير محدد.",
    "Please select a valid image file.": "الرجاء اختيار ملف صورة صالح.",
    "Image size is too large. Please select an image smaller than {size} megabytes.":
      "حجم الصورة كبير جداً. الرجاء اختيار صورة أصغر من {size} ميغابايت.",
    "You must have at least one field in this section.":
      "يجب أن يكون لديك حقل واحد على الأقل في هذا القسم.",
    "payment-success":
      "تم استلام طلبك بنجاح! سيتم إرسال السيرة الذاتية إلى بريدك الإلكتروني قريباً.",
    ...
    "from-city": "من",
    "notification-action": "يقوم الان بإنشاء سيرته الذاتية!",
    ...
    custom_section_placeholder:
      "عنوان القسم الجديد (مثال: المشاريع أو الدورات)",
    ...
    subsection_desc_placeholder:
      "الوصف أو التفاصيل المتعلقة بالعنوان الفرعي...",
    ...
    color_presets_titl: "إعدادات الألوان المسبقة",
    ...
    ai_generating_cv: "جاري إنشاء السيرة الذاتية بالذكاء الاصطناعي...",
    error_name_title_required: "الرجاء إدخال اسم وعنوان الوظيفة للبدء.",
    ai_error_network:
      "تعذر الاتصال بالخادم. الرجاء التحقق من اتصالك بالإنترنت والمحاولة مرة أخرى.",
    ai_error_ratelimit:
      "هناك ضغط كبير على الخدمة حالياً. الرجاء الانتظار لمدة دقيقة ثم المحاولة مرة أخرى.",
    ai_error_parsing:
      "حدث خطأ أثناء معالجة رد الذكاء الاصطناعي. قد يكون الرد غير مكتمل. يرجى المحاولة مجدداً.",
    ai_error_generic:
      "حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى أو التواصل مع الدعم الفني.",
  },
  en: {
    summary_email_required:
      "Please enter your email address in the summary field to continue.",
    "image-paths": {
    ...
    "You must have at least one field in this section.":
      "You must have at least one field in this section.",
    "payment-success":
      "Your request has been successfully received! The CV will be sent to your email shortly.",
    "Error processing file.": "Error processing file.",
    "CV downloaded successfully!": "CV downloaded successfully!",
    "Submitting...": "Submitting...",
    please_wait_and_do_not_refresh:
    ...
    "from-city": "from",
    "notification-action": "is creating CV now!",
    ...
    subsection_desc_placeholder:
      "Description or details related to the sub-heading...",
    ...
    color_presets_titl: "Color Presets",
    ...
    ai_generating_cv: "Generating CV with AI...",
    error_name_title_required: "Please enter a name and job title to start.",
    ai_error_network:
      "Could not connect to the server. Please check your internet connection and try again.",
    ai_error_ratelimit:
      "The service is currently under high load. Please wait a minute and try again.",
    ai_error_parsing:
      "An error occurred while processing the AI response. The response may be incomplete. Please try again.",
    ai_error_generic:
...
const colorPalettes = [
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #8e2de2, #4a00e0)",
      "--secondary-bg": "#4a00e0",
      "--sidebar-bg": "#f3e5f5",
      "--accent-bg": "#d1c4e9",
      "--header-text": "#ffffff",
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #005c97, #363795)",
      "--secondary-bg": "#005c97",
      "--sidebar-bg": "#e0f7fa",
      "--accent-bg": "#b2ebf2",
      "--header-text": "#ffffff",
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #26d0ce, #1a2980)",
      "--secondary-bg": "#26d0ce",
      "--sidebar-bg": "#f1f8e9",
      "--accent-bg": "#dcedc8",
      "--header-text": "#ffffff",
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #ff9a9e, #fad0c4)",
      "--secondary-bg": "#ff9a9e",
      "--sidebar-bg": "#fff5f5",
      "--accent-bg": "#ffcdd2",
      "--header-text": "#ffffff",
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #2e7d32, #c8e6c9)",
      "--secondary-bg": "#2e7d32",
      "--sidebar-bg": "#f1f8e9",
      "--accent-bg": "#a5d6a7",
      "--header-text": "#ffffff",
  ...
  },
  {
    ...
    isGradient: !0,
    colors: {
      "--primary-bg": "linear-gradient(to right, #2c3e50, #4c5a65)",
      "--secondary-bg": "#2c3e50",
      "--sidebar-bg": "#eceff1",
      "--accent-bg": "#b0bec5",
      "--header-text": "#ffffff",
...
function populateFontSelectors() {
  ...
  for (const key in selectors) {
    ...
    if (selectElement) {
      selectElement.onchange = applySelectedFonts; 
  ...
  if (selectors.name)
    selectors.name.value = isArabic
      ? "'Cairo', sans-serif"
      : "'Playfair Display', serif";
  if (selectors.headings)
    selectors.headings.value = isArabic
      ? "'Tajawal', sans-serif"
      : "'Montserrat', sans-serif";
  if (selectors.body)
    selectors.body.value = isArabic
      ? "'Almarai', sans-serif"
      : "'Roboto', sans-serif";
  applySelectedFonts();
}
...
function loadCvDataFromLocalStorage() {
  try {
    ...
    const oldCustomContainer = document.getElementById(
    ...
    if (savedData.customSections && savedData.customSections.length > 0) {
      savedData.customSections.forEach((sectionData) => {
        addCustomSection();
        const allCustomSections = document.querySelectorAll(
          "#custom-sections-container .custom-section-wrapper"
        );
        const newSection = allCustomSections[allCustomSections.length - 1];
        if (newSection) {
          newSection.querySelector(".custom-section-title").value =
            sectionData.title;
          const subSectionsContainer = newSection.querySelector(
          ...
          sectionData.subSections.forEach((subData) => {
            ...
            subSectionEntry.className =
              "custom-subsection-entry border p-2 mb-2 rounded position-relative";
            subSectionEntry.innerHTML = `
                            <button type="button" class="remove-field" onclick="this.parentElement.remove(); generateCV(document.getElementById('cv-container'));" title="${
                              translations[currentLang][
                                "remove_subsection_title"
                              ]
                            }">&times;</button>
                            <input type="text" class="form-control mb-2 custom-subsection-title" placeholder="${
                              translations[currentLang][
                                "subsection_title_placeholder"
                              ]
                            }" value="${
              subData.title || ""
            }" oninput="generateCV(document.getElementById('cv-container'));">
                            <textarea class="form-control custom-subsection-description" placeholder="${
                              translations[currentLang][
                                "subsection_desc_placeholder"
                              ]
                            }" rows="3" oninput="generateCV(document.getElementById('cv-container'));">${
              subData.description || ""
            }</textarea>
                        `;
...
const PRICES = {
  local: { normal: 19, standard: 25, professional: 29, ast: 29, creative: 33 },
  lemonSqueezy: {
    normal: 25,
    standard: 33,
    professional: 39,
...
const CHECKOUT_CONFIG = {
  normal: {
    link: "https://resail-cvs.lemonsqueezy.com/buy/bbfff981-9bd9-495c-b1ac-40b013f5b598",
  },
  standard: {
...
const GOOGLE_APPS_SCRIPT_WEB_APP_URL_PAYMENT_PROCESSOR =
  "https://script.google.com/macros/s/AKfycbxxkX4jsV4zSz4vR7FcCOhYJmXXuOAt5WrJYgZmhTlmO7dzqXARLM6q_5QNo2KVs8bWww/exec";
let salesQueue = [
...
function applySelectedFonts() {
  ...
  livePreviewStyle.textContent = `
        ...
        #cv-container, 
        #cv-container .cv-contact-item p, 
        #cv-container p, 
        #cv-container li, 
        #cv-container div { 
        ...
        /* تجاوز الخط لعناوين الأقسام والعناوين الفرعية */
        #cv-container .cv-section-title,
        #cv-container .cv-job-title,
        #cv-container .cv-degree,
        #cv-container .custom-subsection-title,
        #cv-container .cv-reference-item h4 { 
...
function createPaletteControls() {
  ...
  if (!container) return;
  container.innerHTML = "";
  const showGradientPalettes = !["normal", "standard"].includes(
...
function applyPalette(paletteId) {
  ...
  for (const [key, value] of Object.entries(colors)) {
    ...
    const component = document.querySelector(
      `.color-control-component[data-color-name="${controlName}"]`
    );
    if (component) {
      const toggle = component.querySelector(".gradient-toggle");
      const solidPicker = component.querySelector(
        `#color-picker-${controlName}`
      );
      const startPicker = component.querySelector(
        `#color-picker-${controlName}-start`
      );
      const endPicker = component.querySelector(
        `#color-picker-${controlName}-end`
      );
  ...
  document
    .querySelector(`.palette-swatch[data-palette-id="${paletteId}"]`)
...
async function updateCounters() {
  ...
  try {
    const response = await fetch(
      `${GOOGLE_APPS_SCRIPT_WEB_APP_URL_PAYMENT_PROCESSOR}?action=getCounters`
    );
    if (!response.ok) {
    ...
    if (data.status === "success") {
      ...
      visitorCounterElement.textContent = `+${data.visitorCount.toLocaleString(
        locale
      )}`;
    }
  } catch (error) {
...
function applyDynamicSizes() {
  ...
  const sectionTitleSize = calculateFinalValue(
    "section-title-size-slider",
    1.2
  );
  const subsectionTitleSize = calculateFinalValue(
    "subsection-title-size-slider",
    1.05
  );
  ...
  applyStyleToElements(
    ".cv-contact-item, .cv-contact-item p",
    "font-size",
    contactSize
  );
...
function getColorVariablesAsCssText() {
  ...
  document.querySelectorAll(".color-control-component").forEach((component) => {
    ...
    if (toggle && toggle.checked) {
      const start = component.querySelector(
        `#color-picker-${colorName}-start`
      ).value;
      const end = component.querySelector(
        `#color-picker-${colorName}-end`
      ).value;
  ...
  cssText += `--header-text: ${
    document.getElementById("color-picker-header-text").value
  };`;
  cssText += `--title-text: ${
    document.getElementById("color-picker-title-text").value
  };`;
  cssText += `--body-text: ${
    document.getElementById("color-picker-body-text").value
  };`;
  cssText += `--subtle-text: ${
    document.getElementById("color-picker-subtle-text").value
  };`;
  cssText += "}";
  return cssText;
}
...
function setupColorControls() {
  document.querySelectorAll(".color-control-component").forEach((component) => {
    ...
    component
      .querySelectorAll('input[type="color"], select')
      .forEach((input) => {
        input.addEventListener("input", applySelectedColors);
      });
  });
  document
    .getElementById("color-picker-header-text")
    .addEventListener("input", applySelectedColors);
  document
    .getElementById("color-picker-title-text")
    .addEventListener("input", applySelectedColors);
  document
    .getElementById("color-picker-body-text")
    .addEventListener("input", applySelectedColors);
  document
    .getElementById("color-picker-subtle-text")
    .addEventListener("input", applySelectedColors);
}
function updateColorControlVisibility() {
  const allowedControls =
    CONTROL_VISIBILITY_CONFIG[selectedTemplateCategory] || [];
  document
    .querySelectorAll("#color-picker-container [data-control-for]")
    .forEach((control) => {
      control.style.display = "none";
    });
  allowedControls.forEach((controlName) => {
    const controlElement = document.querySelector(
      `#color-picker-container [data-control-for="${controlName}"]`
    );
    if (controlElement) {
...
function updateControlsForCategory() {
  const cvContainer = document.getElementById("cv-container");
  if (!cvContainer) return;
  const isAdvancedCategory =
    cvContainer.classList.contains("professional-layout") ||
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (lemonSqueezyButton)
    lemonSqueezyButton.addEventListener("click", handleLemonSqueezyPurchase);
...
function addCustomSection() {
  let customSectionsContainer = document.getElementById(
    "custom-sections-container"
  );
  if (!customSectionsContainer) {
    ...
    const formNavigationButtons = document.getElementById(
      "form-navigation-buttons"
    );
    formNavigationButtons.parentNode.insertBefore(
  ...
  titleInput.className =
    "form-control form-control-lg mb-2 custom-section-title";
  titleInput.oninput = () =>
  ...
  addSubSectionButton.onclick = function () {
    ...
    subTitleInput.placeholder =
      translations[currentLang].subsection_title_placeholder;
    subTitleInput.oninput = () =>
      generateCV(document.getElementById("cv-container"));
    const subDescriptionTextarea = document.createElement("textarea");
    subDescriptionTextarea.className =
      "form-control custom-subsection-description";
    subDescriptionTextarea.placeholder =
      translations[currentLang].subsection_desc_placeholder;
    subDescriptionTextarea.rows = 3;
    subDescriptionTextarea.oninput = () =>
      generateCV(document.getElementById("cv-container"));
  ...
  removeSectionButton.textContent =
    translations[currentLang].remove_section_btn;
...
function updateTemplateImageSources() {
  ...
  console.log("Updating template image sources for language:", currentLang);
  templateImages.forEach((img) => {
    ...
    if (
      ...
      const newSrc =
        translations[currentLang]["image-paths"][templateCategory](templateId);
      img.src = newSrc;
      console.log(
        `Setting image src for id ${templateId} (${templateCategory}) to: ${newSrc}`
      );
    } else {
      console.warn(
        `Could not set src for image. templateId: ${templateId}, category: ${templateCategory}, lang: ${currentLang}`
      );
    }
  });
}
...
function updateAllPriceDisplays() {
  ...
  const finalLocalPrice = Math.max(
    0,
    Math.round(originalLocalPrice * (1 - discountApplied / 100))
  );
  const finalLsPrice = Math.max(
    0,
    Math.round(originalLsPrice * (1 - discountApplied / 100))
  );
  ...
  if (localPriceElement) {
    ...
    if (localCurrencyElement) {
      localCurrencyElement.textContent =
        translations[currentLang]["sar-currency"];
    }
  }
...
async function fetchRecentSales() {
  try {
    const response = await fetch(
      `${GOOGLE_APPS_SCRIPT_WEB_APP_URL_PAYMENT_PROCESSOR}?action=getRecentSales`
    );
    const data = await response.json();
...
function toggleLoadingOverlay(show, messageKey = "loading-cv-text") {
  if (loadingOverlayGlobal && loadingTextGlobal) {
    if (show) {
      ...
      const warningText =
        translations[currentLang].please_wait_and_do_not_refresh ||
        "Please do not close or refresh the page...";
      loadingTextGlobal.innerHTML = `${message}<br><small>${warningText}</small>`;
...
function showPage(pageId) {
  ...
  if (pageId === "cv-data-entry-page") {
    ...
    if (aiDataString) {
      ...
      aiData.customSections?.forEach((section) =>
        addCustomSectionFromAI(section)
      );
...
function toggleLanguage() {
  ...
  if (
    cvContainer &&
    (document
      .getElementById("cv-preview-page")
      .classList.contains("active-page") ||
      document
        .getElementById("cv-template-selection-page")
        .classList.contains("active-page") ||
      document
        .getElementById("cv-data-entry-page")
        .classList.contains("active-page"))
  ) {
    generateCV(cvContainer);
  }
...
function updateNavbarLinks() {
  ...
  if (langToggleSpan) {
    langToggleSpan.textContent =
      currentLang === "ar" ? translations.en.English : translations.ar.العربية;
  }
}
function updatePageContentLanguage() {
  const isArabic = currentLang === "ar";
  const allTranslatableElements = document.querySelectorAll(
    "[data-en], [data-ar], [data-translate-id], [data-translate]"
  );
  if (
    loadingOverlayGlobal &&
    loadingOverlayGlobal.style.display === "flex" &&
    ...
    const currentMessageKey =
      loadingTextGlobal.getAttribute("data-current-key") ||
      "Generating CV, please wait...";
    loadingTextGlobal.textContent =
      translations[currentLang][currentMessageKey] || currentMessageKey;
  }
  allTranslatableElements.forEach((element) => {
    ...
    if (
      translateIdKey &&
      translations[currentLang] &&
      translations[currentLang][translateIdKey] !== undefined
    ) {
      newContent = translations[currentLang][translateIdKey];
    } else if (
      translateKey &&
      translations[currentLang] &&
      translations[currentLang][translateKey] !== undefined
    ) {
      newContent = translations[currentLang][translateKey];
    } else {
      const textKeyAttr = isArabic
        ? element.getAttribute("data-ar")
        : element.getAttribute("data-en");
      if (textKeyAttr) {
        if (
          translations[currentLang] &&
          translations[currentLang][textKeyAttr] !== undefined
        ) {
  ...
  const contactEmailLinks = document.querySelectorAll(
    '#contact p strong a, #terms-of-service-page a[href^="mailto:"], #refund-policy a[href^="mailto:"], #privacy-policy a[href^="mailto:"]'
  );
  ...
  if (
    document
      .getElementById("payment-options-page")
      ?.classList.contains("active-page")
  ) {
    updateAllPriceDisplays();
  }
...
async function handleLemonSqueezyPurchase() {
  toggleLoadingOverlay(!0, "preparing_secure_payment");
  try {
    ...
    const getDynamicStylesAsCssText = () => {
      ...
      const nameFont =
        document.getElementById("font-selector-name")?.value ||
        "'Playfair Display', serif";
      const headingsFont =
        document.getElementById("font-selector-headings")?.value ||
        "'Montserrat', sans-serif";
      const bodyFont =
        document.getElementById("font-selector-body")?.value ||
        "'Roboto', sans-serif";
      ...
      styles += `.cv-name { font-size: ${calculateFinalValue(
        "name-size-slider",
        2.5
      )}em !important; }`;
      styles += `.cv-title { font-size: ${calculateFinalValue(
        "title-size-slider",
        1.3
      )}em !important; }`;
      styles += `.cv-contact-item, .cv-contact-item p { font-size: ${calculateFinalValue(
        "contact-size-slider",
        0.95
      )}em !important; }`;
      styles += `.cv-section-title { font-size: ${calculateFinalValue(
        "section-title-size-slider",
        1.2
      )}em !important; }`;
      const subsectionSelectors = [
      ...
      styles += `${subsectionSelectors} { font-size: ${calculateFinalValue(
        "subsection-title-size-slider",
        1.05
      )}em !important; }`;
      const bodySelectors = [
      ...
      styles += `${bodySelectors} { font-size: ${calculateFinalValue(
        "body-text-size-slider",
        0.9
      )}em !important; }`;
      return styles;
    ...
    const imageSize =
      document.getElementById("image-size-slider")?.value || 120;
    const imageRadius =
      document.getElementById("image-radius-slider")?.value || 50;
    ...
    const prepareResponse = await fetch(
      `${NODE_SERVER_URL}/api/prepare-checkout`,
      {
        method: "POST",
...
async function applyDiscountCode() {
  ...
  if (code && discountCodes[code] !== undefined) {
    ...
    alert(
      currentLang === "ar"
        ? `تم تطبيق كود الخصم "${code}". سيتم تحديث السعر.`
        : `Discount code "${code}" applied. The price will be updated.`
    );
    document.getElementById("remove-discount-container").style.display =
      "block";
  } else if (code) {
    removeDiscount();
    alert(
      currentLang === "ar" ? "كود الخصم غير صالح." : "Invalid discount code."
    );
  } else {
    removeDiscount();
  }
...
function updatePriceDisplay(discountedPrice) {
  ...
  if (finalPriceText) {
    ...
    finalPriceText.textContent =
      (translations[currentLang].messages || "Price Paid") +
      ": " +
      discountedPrice +
      currency;
  }
...
function getDiscountedPrice() {
  if (discountApplied > 0 && discountApplied <= 100) {
    return Math.max(
      0,
      Math.round(selectedPriceToPay * (1 - discountApplied / 100))
    );
  }
...
function openQrPaymentPage(method, templateCategory) {
  ...
  if (qrManualPaymentPage) {
    ...
    qrManualPaymentPage.setAttribute("data-discount-code", appliedDiscountCode);
    qrManualPaymentPage.setAttribute(
      "data-cv-template-category",
      templateCategory
    );
...
async function submitPaymentProof(event) {
  ...
  submitButton.innerHTML = `<span class="spinner-border spinner-border-sm"></span> ${
    translations[currentLang]["Submitting..."] || "Submitting..."
  }`;
  const qrPaymentResultDiv = document.getElementById("qr-payment-result");
  ...
  try {
    ...
    const qrManualPaymentPage = document.getElementById(
      "qr-manual-payment-page"
    );
    const paymentMethod = qrManualPaymentPage.getAttribute(
      "data-payment-method"
    );
    const cvTemplateCategory = qrManualPaymentPage.getAttribute(
      "data-cv-template-category"
    );
    const pricePaid = qrManualPaymentPage.getAttribute("data-price-paid");
    const actualDiscountCodeStr =
      qrManualPaymentPage.getAttribute("data-discount-code") || "N/A";
    if (!name || !email) {
      throw new Error(
        translations[currentLang]["Please fill in all fields."] ||
          "Please fill in all required fields."
      );
    }
    if (!validateEmail(email)) {
      throw new Error(
        translations[currentLang]["Please enter a valid email."] ||
          "Please enter a valid email address."
      );
    }
    toggleLoadingOverlay(!0, "payment_processing");
    const fileBase64 = file ? await fileToBase64(file) : null;
    const pdfData = await generatePdfFromNode(!0);
    ...
    formData.append(
      "cvPdfFileName",
      `CV_Preview_${name.replace(/\s/g, "_")}.pdf`
    );
    ...
    const response = await fetch(
      GOOGLE_APPS_SCRIPT_WEB_APP_URL_PAYMENT_PROCESSOR,
...
function getExperiencesData() {
  const experiences = [];
  document
    .querySelectorAll("#experience-input .experience-entry")
    .forEach((entry) => {
      ...
      const duration = entry
        .querySelector(".experience-duration")
        ?.value.trim();
...
function getEducationsData() {
  const educations = [];
  document
    .querySelectorAll("#education-input .education-entry")
    .forEach((entry) => {
      const degree = entry.querySelector(".education-degree")?.value.trim();
      const institution = entry
        .querySelector(".education-institution")
        ?.value.trim();
...
function getLanguagesData() {
  const languages = [];
  document
    .querySelectorAll("#languages-input .language-item-input")
    .forEach((input) => {
...
function getReferencesData() {
  const references = [];
  document
    .querySelectorAll("#references-input .reference-entry")
    .forEach((entry) => {
...
function getCustomSectionsData() {
  const sections = [];
  document
    .querySelectorAll("#custom-sections-container .custom-section-wrapper")
    .forEach((sectionWrapper) => {
      const sectionTitle = sectionWrapper
        .querySelector(".custom-section-title")
        ?.value.trim();
      if (!sectionTitle) return;
      const subSections = [];
      sectionWrapper
        .querySelectorAll(".custom-subsection-entry")
        .forEach((subSectionEntry) => {
          const subTitle = subSectionEntry
            .querySelector(".custom-subsection-title")
            ?.value.trim();
          const description = subSectionEntry
            .querySelector(".custom-subsection-description")
            ?.value.trim();
      ...
      if (subSections.length > 0) {
        sections.push({ title: sectionTitle, subSections: subSections });
      }
    });
  return sections;
}
function getSelectedTemplateCss() {
  ...
  const commonSelectorsRegex = new RegExp(
    `(^|\\b)(<span class="math-inline">\{commonSelectors\.map\(s \=\> s\.replace\('\.', '\\\\\.'\)\)\.join\('\|'\)\}\)\(\\\\b\|</span>)`
  );
    ...
    try {
      ...
      for (let j = 0; j < rules.length; j++) {
        ...
        if (selectorText) {
          ...
          const isTemplateSpecific = selectorText.includes(
            templateSpecificSelector
          );
          const isCvRelated = selectorText.includes(".cv-");
          const isFrontendUI =
            selectorText.includes(".navbar") ||
            selectorText.includes(".site-header") ||
            selectorText.includes(".page-section:not") ||
            selectorText.includes(".progress-container") ||
            selectorText.includes(".language-toggle");
          if (
            (isGeneral || isTemplateSpecific || isCvRelated) &&
            !isFrontendUI
          ) {
            cssRules.push(ruleText);
          }
      ...
      console.warn(
        `Could not read CSS rules from stylesheet (possibly CORS issue): ${e.message}`
      );
    }
  }
  cssRules.push(`
        ...
        .cv-sidebar, .cv-main-content {
            ...
            } !important; /* Text alignment within the column */
        }
...
async function generatePdfFromNode(isPaid) {
  toggleLoadingOverlay(!0, "pdf_generation_in_progress");
  try {
    const cvPreviewElement = document.getElementById("cv-container");
    if (!cvPreviewElement) throw new Error("CV container not found.");
    const fetchCss = async (url) => {
    ...
    const nameFont =
      document.getElementById("font-selector-name")?.value ||
      (isArabic ? "'Cairo', sans-serif" : "'Playfair Display', serif");
    const headingsFont =
      document.getElementById("font-selector-headings")?.value ||
      (isArabic ? "'Tajawal', sans-serif" : "'Montserrat', sans-serif");
    const bodyFont =
      document.getElementById("font-selector-body")?.value ||
      (isArabic ? "'Almarai', sans-serif" : "'Roboto', sans-serif");
    const getDynamicSizeCssAsText = () => {
      let sizeCss = "";
      const sliders = {
        "name-size-slider": { selector: ".cv-name", unit: "em" },
        "title-size-slider": { selector: ".cv-title", unit: "em" },
        "contact-size-slider": {
          selector: ".cv-contact-item, .cv-contact-item p",
          unit: "em",
        },
        "section-title-size-slider": {
        ...
        "subsection-title-size-slider": {
          selector:
            ".cv-job-title, .cv-degree, .custom-subsection-title, .cv-reference-item h4",
          unit: "em",
        },
        "body-text-size-slider": {
          selector:
            "#objective p, .cv-experience-item p, .cv-company, .cv-institution, .cv-duration, .skill-name, .cv-language-list li, .cv-reference-item p, .custom-subsection-description",
          unit: "em",
        },
      };
      for (const [sliderId, data] of Object.entries(sliders)) {
        const slider = document.getElementById(sliderId);
        if (slider) {
          sizeCss += `${data.selector} { font-size: ${slider.value}${data.unit} !important; }\n`;
        }
      }
      const imageSize = document.getElementById("image-size-slider")?.value;
      const imageRadius = document.getElementById("image-radius-slider")?.value;
      if (imageSize) {
        sizeCss += `#cv-container { --image-size: ${imageSize}px !important; }\n`;
      }
      if (imageRadius) {
        sizeCss += `#cv-container .cv-profile-pic { --image-radius: ${imageRadius}% !important; border-radius: ${imageRadius}% !important; }\n`;
      }
      return sizeCss;
    };
    ...
    const printCssOverrides = `
            ...
            /* ⭐⭐⭐ القاعدة الجديدة التي سيستخدمها الخادم ⭐⭐⭐ */
            .break-before-me {
                page-break-before: always !important; /* يجبر العنصر على البدء في صفحة جديدة */
                padding-top: 5mm !important;          /* يضيف هامشاً علوياً كما طلبت للعنصر الذي تم نقله */
            }

            #cv-container p, #cv-container li, #cv-container .cv-contact-item,
            #cv-container .cv-company, #cv-container .cv-institution, #cv-container .cv-duration,
            #cv-container .skill-name, #cv-container .cv-reference-item p {
                font-family: ${bodyFont} !important;
            }

            /* القواعد المحددة للاسم والعناوين (تبقى كما هي ولكنها أكثر وضوحًا الآن) */
            #cv-container .cv-name, #cv-container .cv-title { 
                font-family: ${nameFont} !important; 
            }
            #cv-container .cv-section-title, #cv-container .cv-job-title, 
            #cv-container .cv-degree, #cv-container .custom-subsection-title, 
            #cv-container .cv-reference-item h4 {
                font-family: ${headingsFont} !important;
            }
            ${getDynamicSizeCssAsText()}
            ${colorVariablesCSS}
            ${dynamicStyleRule}
    ...
    const fullPageHtml = `
      ...
      cvData.templateCategory
    }-layout template${cvData.templateNumber}" dir="${direction}">
                    ${finalHtml}
                 </div>
            </body>
            </html>
...
async function sendFinalHtmlToServer(finalHtml, isPaid) {
  const mainCssText =
    document.getElementById("main-stylesheet")?.textContent || "";
  if (!mainCssText) {
  ...
  if (!response.ok) {
    ...
    throw new Error(
      `Node.js server error: ${response.status} - ${errorBody.message}`
    );
  }
 ...
 */
async function sendPaymentDataToAppsScript(
  paymentMethod,
  pricePaid,
  cvPdfBase64,
  paymentFile
  ...
  try {
    ...
    const name =
      document.getElementById("name-input")?.value.trim() || "Unnamed User";
    const email = document.getElementById("email-input")?.value.trim();
    ...
    formData.append(
      "discountCode",
      appliedCode || (pricePaid === 0 ? "FREECV" : "N/A")
    ); // Ensure FREECV is sent
    formData.append("language", currentLang);
    ...
    alert(
      (translations[currentLang]["Error processing file."] || "Error:") +
        " " +
        err.message
    );
...
function selectTemplate(clickedElement, templateNumber, category) {
  ...
  document
    .querySelectorAll(".template-preview")
    .forEach((p) => p.classList.remove("selected-template"));
  if (clickedElement) {
...
function handleProfilePicChange(event) {
  ...
  if (file.size > MAX_FILE_SIZE) {
    alert(
      translations[currentLang][
        "Image size is too large. Please select an image smaller than {size} megabytes."
      ].replace("{size}", MAX_FILE_SIZE / 1024 / 1024)
    );
    inputElement.value = "";
    if (fileNameDisplay) fileNameDisplay.textContent = "";
    if (picPreview) picPreview.style.display = "none"; // ⭐ إخفاء المعاينة عند الخطأ
...
function addExperienceField(data = null) {
  ...
  newEntry.innerHTML = `
        ...
        <input type="text" placeholder="${
          translations[currentLang]["Job Title_placeholder"] || "Job Title"
        }" class="experience-title" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang].Company || "Company"
        }" class="experience-company" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang].Duration || "Duration"
        }" class="experience-duration" oninput="generateCV(cvContainer);updateProgress()">
        <textarea placeholder="${
          translations[currentLang].Description || "Description"
        }" class="experience-description" oninput="generateCV(cvContainer);updateProgress()"></textarea>
    `;
  ...
  if (data) {
    ...
    if (Array.isArray(data.description)) {
      ...
      newEntry.querySelector(".experience-description").value =
...
function addEducationField(data = null) {
  ...
  newEntry.innerHTML = `
        ...
        }" class="education-degree" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang]["University/Institution"] ||
          "University/Institution"
        }" class="education-institution" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang].Duration || "Duration"
        }" class="education-duration" oninput="generateCV(cvContainer);updateProgress()">
    `;
  educationInput.appendChild(newEntry);

  if (data) {
    newEntry.querySelector(".education-degree").value = data.degree || "";
    newEntry.querySelector(".education-institution").value =
      data.institution || "";
...
function addSkillField(data = null) {
  ...
  nameInput.placeholder =
    translations[currentLang]["Enter a skill"] || "Enter a skill";
  nameInput.oninput = () => {
    generateCV(cvContainer);
    updateProgress();
  };
...
function addLanguageField(data = null) {
  ...
  newEntry.innerHTML = `
        <button type="button" class="remove-field" onclick="removeField(this)"><i class="fas fa-times-circle"></i></button>
        <input type="text" placeholder="${
          translations[currentLang]["Enter a language"] || "Enter a language"
        }" class="language-item-input" oninput="generateCV(cvContainer);updateProgress()">
    `;
...
function addReferenceField(data = null) {
  ...
  newEntry.innerHTML = `
        ...
        }" class="reference-name" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang].Position || "Position"
        }" class="reference-position" oninput="generateCV(cvContainer);updateProgress()">
        <input type="text" placeholder="${
          translations[currentLang].Phone || "Phone"
        }" class="reference-phone" oninput="generateCV(cvContainer);updateProgress()">
        <input type="email" placeholder="${
          translations[currentLang].Email || "Email"
        }" class="reference-email" oninput="generateCV(cvContainer);updateProgress()">
    `;
...
function generateCV(targetElement) {
  ...
  const website = document.getElementById("website-input")?.value.trim() || "";
  const objective =
    document.getElementById("objective-input")?.value.trim() || "";

  // --- 2. بناء أجزاء HTML ---
  const endMarkerHTML = createEndMarkerHTML();
  let profilePicHTML = profilePicDataUrl
    ? `<img src="${profilePicDataUrl}" class="cv-profile-pic" alt="Profile Picture">`
    : "";

  let contactInfoHTML = `<div class="cv-section" data-section-name="contact-info"><div class="cv-contact-info">`;
  if (emailVal)
    contactInfoHTML += `<div class="cv-contact-item"><i class="fas fa-envelope"></i><p>${emailVal}</p></div>`;
  if (phone)
    contactInfoHTML += `<div class="cv-contact-item"><i class="fas fa-phone"></i><p>${phone}</p></div>`;
  if (website)
    contactInfoHTML += `<div class="cv-contact-item"><i class="fas fa-map-marker-alt"></i><p>${website}</p></div>`;
  contactInfoHTML += "</div></div>";

  const objectiveHTML = objective
    ? `<div class="cv-section" id="objective"><h3 class="cv-section-title">${
        translations[currentLang]["Career Objective"]
      }</h3><p>${objective.replace(/(\r\n|\n|\r)+/g, "<br>")}</p></div>`
    : "";
  ...
  if (
    ...
    experienceEntries.some((e) => e.title || e.company)
  ) {
    ...
    experienceEntries.forEach((entry) => {
      if (entry.title || entry.company) {
        experienceHTML += `<div class="cv-experience-item"><h4 class="cv-job-title">${
          entry.title
        }</h4><h5 class="cv-company">${entry.company}${
          entry.company && entry.duration ? " - " : ""
        }${entry.duration}</h5><p>${entry.description.replace(
          /(\r\n|\n|\r)+/g,
          "<br>"
        )}</p></div>`;
      }
  ...
  if (
    ...
    educationEntries.some((e) => e.degree || e.institution)
  ) {
    ...
    educationEntries.forEach((entry) => {
      if (entry.degree || entry.institution) {
        educationHTML += `<div class="cv-education-item"><h4 class="cv-degree">${
          entry.degree
        }</h4><h5 class="cv-institution">${entry.institution}${
          entry.institution && entry.duration ? " - " : ""
        }${entry.duration}</h5></div>`;
      }
    });
    educationHTML += "</div>";
  }
  ...
  if (customSections.length > 0) {
    customSections.forEach((section) => {
      customSectionsHTML += `<div class="cv-section" id="custom-${section.title.replace(
        /\s+/g,
        "-"
      )}">`;
  ...
  const skillsContainerClass =
    selectedTemplateCategory === "normal"
      ? "horizontal-skills"
      : "vertical-skills";
  ...
  if (referenceEntries.length > 0 && referenceEntries.some((r) => r.name)) {
    ...
    referenceEntries.forEach((ref) => {
      if (ref.name) {
        referencesHTML += `<div class="cv-reference-item"><h4>${
          ref.name
        }</h4><p>${ref.position || ""}</p><p>${ref.phone || ""}</p><p>${
          ref.email || ""
        }</p></div>`;
      }
    });
  ...
  // === بداية: الكود المصحح الذي يعالج كل الفئات المتبقية ===
    ...
    // هذا الكود سيعالج الآن Standard, AST, و Professional بشكل صحيح
    ...
    if (selectedTemplateCategory === "professional") {
      ...
      if (selectedTemplate == 1 || selectedTemplate == 3) {
        ...
        const contactForHeader = contactInfoHTML
          .replace(
            '<div class="cv-section" data-section-name="contact-info">',
            ""
          )
          .replace(/<\/div>$/, "");
      ...
      // هذا الجزء يعالج Standard و AST كما كان
...
function createEndMarkerHTML() {
  const endText =
    translations[currentLang]["End of CV"] ||
    (currentLang === "ar" ? "نهاية السيرة" : "End of CV");
...
function updateProgress() {
  ...
  if (totalSections > 0)
    currentWeight +=
      (filledSectionsCount / totalSections) * sectionsOverallWeight;
...
async function handleFreeCvDownload() {
  ...
  if (!validateEmail(email)) {
    alert(
      currentLang === "ar"
        ? "الرجاء إدخال بريد إلكتروني صالح أولاً للمتابعة."
  ...
  freeCard.innerHTML = `<div class="spinner-border spinner-border-sm" role="status"></div><span class="ms-2">${
  ...
  try {
    ...
    const success = await sendPaymentDataToAppsScript(
      "FREECV Payment",
      0,
      pdfData.base64Pdf,
      null
    ...
    if (success) {
      ...
      a.href = url;
      a.download = `CV_${
        document.getElementById("name-input")?.value.replace(/\s/g, "_") ||
        "ResailCV"
      }.pdf`;
...
document.querySelector("#cv-preview-page .btn-info.ms-3").onclick =
  async function () {
...
document.querySelector("#cv-preview-page .btn-success.ms-3").onclick =
  function () {
  ...
  const timerInterval = setInterval(() => {
    ...
    if (distance < 0) {
      ...
      countdownElement.textContent =
        translations[currentLang]?.["offer_expired"] || "Offer Expired";
...
async function initializeCountdown() {
  try {
    const response = await fetch(
      `${GOOGLE_APPS_SCRIPT_WEB_APP_URL_PAYMENT_PROCESSOR}?action=getTimerConfig`
    );
    if (!response.ok)
      throw new Error("Network response was not ok for timer config.");
...
function handleFloatingButtonVisibility() {
  ...
  const isLandingPageActive = document
...
async function triggerAiGeneration(
  ...
  try {
    ...
    if (!jsonMatch)
      throw new Error(
        "Could not find a valid JSON object in the server response."
      );
    ...
    aiButton.addEventListener("click", () => {
      ...
      if (savedData && Object.keys(JSON.parse(savedData)).length > 2) {
        ...
        const summary = document
          .getElementById("hero-summary-input")
          .value.trim();
  ...
  if (improveButton) {
    improveButton.addEventListener("click", () => {
      ...
      const objective = document
        .getElementById("objective-input")
        ?.value.trim();

      // Prioritize using the original AI-generated data for refinement if it exists.
      let existingDataJSON = localStorage.getItem(
        "resailInitialAiData_" + currentLang
      );

      // If no initial AI data is stored (e.g., manual entry), fall back to the currently saved form data.
      if (!existingDataJSON) {
        console.log(
          "No initial AI data found.Falling back to current form data for improvement."
        );
      ...
      if (!existingDataJSON || existingDataJSON === "{}") {
        alert(
          currentLang === "ar"
            ? "لا توجد بيانات لتحسينها. يرجى إنشاء سيرة ذاتية أولاً."
            : "No data to improve. Please generate a CV first."
        );
        return;
      }
...
function addCustomSectionFromAI(sectionData) {
  ...
  if (!customSectionsContainer) {
    ...
    if (formNavigationButtons && formNavigationButtons.parentNode) {
      ...
      document
        .querySelector("#cv-data-entry-page .col-md-6:last-child")
        .appendChild(customSectionsContainer);
    }
  }
...
/**
 * دالة "البدء من جديد" التي سيتم ربطها بالزر الجديد.*/ function handleStartOver() {
  const confirmationMessage =
    currentLang === "ar"
  ...
  if (confirm(confirmationMessage)) {
    localStorage.removeItem("resailCvData_" + currentLang);
    localStorage.removeItem("resailInitialAiData_" + currentLang);
    clearAllCvFields();
    ...
    alert(
      currentLang === "ar"
        ? "تم مسح البيانات. يمكنك الآن البدء من جديد."
        : "Data cleared. You can now start over."
    );
  }
}
